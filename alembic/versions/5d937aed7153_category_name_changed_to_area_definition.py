"""'category' name changed to 'area definition' 

Revision ID: 5d937aed7153
Revises: b115156a779b
Create Date: 2026-01-07 13:17:13.287884
...
revision: str = '5d937aed7153'
down_revision: Union[str, Sequence[str], None] = 'b115156a779b'
...
def upgrade():
    ...
    # 3. Make NOT NULL (only if required)
    op.alter_column(
        'users',
        'area_definition_id',
        nullable=False
